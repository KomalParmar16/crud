...
<head>
  ...
  <title>CRUD Application Using PHP OOPS PDO MySQL & FETCH API</title>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="add-user-form" class="p-2" novalidate>
            ...
            <div class="mb-3">
              <input type="tel" name="phone" pattern="[0-9]{4}[0-9]{2}[0-9]{4}" class="form-control form-control-lg" placeholder="Enter Phone" required>
